...
VERSION 11 — REPORTING AND AUDIT
--------------------------------
- Confirmed revenue dashboard.
- Payment and deleted-application summary cards.
- Today's application count and top services.
- Export applications to CSV.
- Export audit history to CSV.
- Database audit log records application inserts, updates and deletions.
