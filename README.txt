...
VERSION 9 — AUTOMATIC CATEGORY SELECTION
- Choosing a standard Service Name automatically selects its Category.
- Required-document templates continue to populate automatically.
- Other / Custom still supports custom service and category values.
- No Supabase SQL migration is required.

VERSION 10 — MOBILE GROWTH AND CUSTOMER ACQUISITION
---------------------------------------------------
- Mobile-first service search on the home page.
- Popular services loaded automatically from Supabase.
- One-click Apply buttons for popular services.
- Floating mobile actions for Apply, Track and WhatsApp.
- Installable Progressive Web App support.
- Basic offline app-shell caching.
- SEO meta tags, robots.txt and sitemap.xml.
- Trust, customer-experience and FAQ sections.
- Social-sharing metadata for WhatsApp, Facebook and other platforms.

No Supabase migration is required.
Upload all Version 10 files to GitHub and wait for Vercel deployment.
