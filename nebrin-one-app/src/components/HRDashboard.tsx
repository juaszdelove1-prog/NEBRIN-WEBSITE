...
export function HRDashboard({payload,executive=false}:{payload:HRPayload|null;executive?:boolean}){
 ...
 return <>
  <Card title={executive?'Workforce & HR Oversight':'HR Command Centre'}>
   {executive?<Text style={st.note}>Executive read-only workforce overview. Recruitment processing, employee onboarding and HR administration remain with the Human Resources department.</Text>:null}
   <View style={st.grid}>
  ...
  <Card title={executive?'Executive Employee Directory':'Employee Directory'}>
  ...
  <Card title={executive?'Staffing Requests — Executive Oversight':'Staffing & Recruitment Requests'}>
   {executive?<Text style={st.note}>Shows demand and recruitment status only; HR continues recruitment execution and departmental processing.</Text>:null}
